    ...
    if (['home', 'dashboard', 'feed', 'admin', 'profile', 'credit_history', 'notifications', 'buy_credits'].includes(state.currentView)) {
        ...
        topbar.innerHTML = `
            ...
            <div style="display: flex; gap: 20px; align-items: center;">
                ${!state.loggedInUser ? `
                    <button id="nav-register-btn" class="releaf-button" style="background: #DA291C; color: #fff; font-weight: bold; margin: 0; padding: 8px 18px; font-size: 0.85rem;">εγγραφή</button>
...
function renderSidebar() {
    ...
    sidebar.innerHTML = `
        ...
        <h3 style="font-family: var(--font-heading); font-size: 1.5rem; color: #DA291C; border-bottom: 2px solid rgba(255,255,255,0.1); padding-bottom: 10px; margin-top: 60px;">μενού</h3>
    ...
    if (!state.loggedInUser) {
        ...
        list.innerHTML = `
            <li id="side-link-feed" style="margin: 20px 0; cursor: pointer; color: #DA291C; font-weight: bold;">🌍 Feed (Αγγελίες)</li>
            ...
            <li id="side-link-profile" style="margin: 20px 0; cursor: pointer; color: #fff;">👤 Προφίλ</li>
            <li id="side-link-buy" style="margin: 20px 0; cursor: pointer; color: #DA291C;">🪙 Αγορά Credits</li>
        `;
